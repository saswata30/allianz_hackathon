...
-- MAGIC %md
-- MAGIC # 04 · Firmwide reference data (Delta)
-- MAGIC Book-of-business premium & exposure by line of business × region — the denominator
-- MAGIC for loss-ratio **correlation** in the gold layer. If you renamed the catalog in
-- MAGIC `00_config`, update it here too.
...
FROM allianz_hackathon.reference.firmwide_exposure
